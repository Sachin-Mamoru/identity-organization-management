...
import static org.wso2.carbon.identity.organization.management.application.constant.SQLConstants.*;
...
public class OrgApplicationMgtDAOImpl implements OrgApplicationMgtDAO {
    ...
    @Override
    public Optional<MainApplicationDO> getMainApplication(String sharedAppId, String sharedOrgId) throws OrganizationManagementException {
